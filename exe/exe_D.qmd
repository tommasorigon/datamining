...
[Prove]{.orange} the theorem on [leave-one-out cross-validation]{.blue} for "projective" linear smoothers, as described in [this slide](../slides/un_D.html#choice-of-the-bandwidth-ii).  

Then, show that the theorem holds for the following estimators:  
  ...
  iii. Regression splines. [Hint]{.blue}: this is a special case of a linear model, so you can prove the theorem directly rather than by establishing the projectivity property.  
  iv. Smoothing splines. [Hint]{.blue}: again, you may want to use the Sherman–Morrison formula and prove the theorem directly.  
