...
#### Exercise D.2 - Differentiability of Nadaraya-Watson
...
#### Exercise D.3 - Local linear regression (explicit formula)
...
#### Exercise D.4 - Preservation of linear trends
...
#### Exercise D.5 - Conceptual exercise
...
#### Exercise D.6 - Leave-one-out cross-validation
...
#### Exercise D.7 - Truncated power basis
...
#### Exercise D.8 - Optimality of smoothing splines

#### Exercise D.9 - Smoothing splines estimator

[Derive]{.orange} the smoothing spline estimator $\hat{\beta} = (\bm{N}^T\bm{N} + \lambda \bm{\Omega})^{-1}\bm{N}^T\bm{y}$.
