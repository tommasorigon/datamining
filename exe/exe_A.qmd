...
$$
Moreover, show that $\bm{H}^2 = \bm{H}$. You may want to look for the properties of [projection matrices]{.orange} on your favorite linear algebra textbook, otherwise this exercise becomes quite hard. 
...
The second part of this exercise is quite [hard]{.blue} and [optional]{.blue}, because it involves a lot of algebraic steps. Check the correctness of the deviance formula:
$$
