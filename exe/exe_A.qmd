...
[Verify]{.orange} the correctness of the [recursive least square]{.blue} equations described in [this slide](../slides/un_A.html#the-recursive-least-squares-algorithm-i). The proof is already concisely written in the slides, you just need to convince yourself of the correctness of every step. 

Moreover, check the correctness for the deviance formula:
$$
