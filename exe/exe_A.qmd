...
#### Exercise A - Properties of $\bm{H}$ - Solution: [`notes.pdf`](exe_A_A.pdf)
...
:::{.callout-note collapse=true}
#### Exercise B - Positive definiteness of $\bm{X}^T\bm{X}$ - Solution: [`notes.pdf`](exe_A_B.pdf)
...
:::{.callout-note collapse=true}
#### Exercise C - OLS with orthogonal predictors - Solution: [`notes.pdf`](exe_A_C.pdf)
...
:::{.callout-note collapse=true}
#### Exercise D - Recursive least squares - Solution: [`notes.pdf`](exe_A_D.pdf)
...
:::{.callout-note collapse=true}
#### Exercise E - Separability in logistic regression - Solution: [`notes.pdf`](exe_A_E.pdf)
...
:::{.callout-note collapse=true}
#### Exercise F - Standardization of the input variables - Solution: [`notes.pdf`](exe_A_F.pdf)
...
A detailed description is also provided in [Algorithm 2.2]{.blue} of Azzalini \& Scarpa, 2011
:::

:::{.callout-note collapse=true}
#### Exercise H - Iteratively re-weighted least squares for logistic regression
...
Verify that the output of `logistic_mle` and the built-in `glm` function coincide, using the [heart dataset](../slides/un_A.html#the-heart-dataset).
