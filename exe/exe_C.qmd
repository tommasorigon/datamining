...
$$
    ...
    $$
[Note]{.orange}. In ridge regression, you need to include a $n^{-1}$ scaling factor in the least squares penalty; i.e. you need to consider ridge as a special case of [this equation](../slides/un_C.html#elastic-net-with-a-single-predictor). This makes the values of $\lambda$ comparable between ridge and lasso. 
