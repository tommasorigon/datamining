...
#### Exercise A - Bias-variance decomposition - Solution: [`notes.pdf`](exe_B_A.pdf)
...
:::{.callout-note collapse=true}
#### Exercise B - An estimator with minimal variance - Solution: [`notes.pdf`](exe_B_B.pdf)
...
:::{.callout-note collapse=true}
#### Exercise C - Heteroscedastic errors
