...
[Prove]{.orange} the leave-one-out formula for linear models stated in [this slide](../slides/un_B.html#leave-one-out-cross-validation). [Hint]{.blue}: many steps are similar to those needed for obtaining [recursive least squares]{.blue}.
