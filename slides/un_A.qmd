...
-   The first part of the unit is a tour in the "old style" data
...
::: incremental
-   In many occasions, the data flows continuously, meaning that we get
...
-   The [true positive rate]{.blue} ([specificity]{.orange}) is defined
    as $$
    \text{specificity} = 1 - \mathbb{P}(``\text{false positive}") \approx \frac{n_{00}}{n_{00} + n_{10}} = \frac{255}{255 + 47} = 0.844.
    $$
-   On the other hand, the [true negative rate]{.blue}
