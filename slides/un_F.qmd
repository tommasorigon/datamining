...
-   Especially when $p$ is large, it is not feasible to manually model [interactions]{.orange} among covariates. GAMs do not take second-order effects (or higher) into account. 
:::
