...
-   The [degree $d$]{.orange} of the MARS algorithms allow to control
    the number order of interactions of the model. Note that when
...
- We can now check the predictive performance on the [test set]{.orange}, to see which is model scored the best in terms of MAE and RMSE.
