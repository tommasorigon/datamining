...
- The backfitting algorithm, when $f_j$ are modeled as [regression splines]{.blue}, is known as the Gauss-Seidel algorithm and [convergence]{.orange} is [guaranteed]{.orange} under standard conditions.
...
$$
The number of degrees of the whole model therefore is $1 + \sum_{j=1}^p \text{df}_j$. 
