...
-   Examples of loss functions for [binary classification problems]{.blue}
    $Y \in \{0, 1\}$ are:
    -   The [misclassification rate]{.orange}, wich is defined as
        $$
...
- In classification problems, under a misclassification loss, the [Bayes rate]{.blue} is the error rate we would get if we knew the true $p(\bm{x})$. 

- asd

- The Bayes rate is the [irreducible error]{.orange} for classification problems.  
