...
-   Let us better formalize the analysis we have done so far using the appropriate
    mathematical tools.
...
- After the appropriate adjustments, the principles described for regression settings also apply to [classification problems]{.blue}. We focus on the binary case $Y \in \{0, 1\}$.
...
- The factor $2$ is just a [cosmetic convention]{.blue}, introduced to match the quantities of the usual asymptotic theory. 
...
- several other proposals followed Akaike's original work,
