...
- Even when the primary interest is on predictions, we can often say something about the [association]{.orange} between the response variable and the covariates. Finding association is appropriate even in the presence of biased estimates.
...
- However, you [should not]{.orange} fit a sophisticated model without trying the simple ones first.

- In other terms, you can fit a [deep neural network]{.blue} only after [everything else has failed]{.orange}.
