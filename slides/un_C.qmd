...
::: callout-note
-   From now on, we will assume the data have been previously [centered]{.orange}, so that $$
...
- We stress that the centering operation unconsequential, because it is possible to transform back the predictions into the original scale. 
