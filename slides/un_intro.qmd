...
-   If you are in this class today, it means...
    ...
    -  You may have attended a course named "data mining" before, and
        studied basic tools like linear discriminant analysis, $k$-nearest neighbors...
:::
...
![](img/flex.png){fig-align="center" width=50%}
...
- Predictive [interpretability]{.blue} means transparent understanding the [driving factors]{.blue} of the predictions. An example are linear models with few (highly relevant) variables. 

- For example, if I change the value of a set covariates, what is the impact on predictions?
...
- Statistics was there before data mining, machine learning, data science and before all these fancy new names. 

- Statistical regression methods go back to Gauss and Legendre in the early 1800s. Their goal was indeed [prediction]{.blue}!
:::
...
- [Modern statistics]{.blue} encompasses [also]{.orange}:
  ...
  - Algorithmic and modelling culture to prediction.
...
- Competence in [computational aspects]{.blue} is helpful to better evaluate the output of the computer, e.g. in terms of its [reliability]{.orange}.
...
- (20 / 30) A [written examination]{.blue}: a pen-and-paper exam about the theoretical aspects of the course.

- (10 / 30) An [individual assignment]{.blue}: a data challenge. 
...
- Both parts are [mandatory]{.orange} and you need to submit the assignment [before]{.orange} attempting the written part.
...
- "*Those who ignore statistics are condemned to reinvent it*". [Bradley Efron]{.grey}, Stanford University.

## References

-   [Main references]{.blue}
    -   **Chapter 1** of Azzalini, A. and Scarpa, B. (2011), [*Data
        Analysis and Data
