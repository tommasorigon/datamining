...
- The regression function $f(x_i) = \mathbb{E}(\tilde{Y}_i)$ is the [optimal prediction]{.blue} even in presence of heroschedastic data or when the above [additive]{.orange} decomposition does [not hold]{.orange}.
