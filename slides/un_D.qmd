...
-   The regression function $f(x_i) = \mathbb{E}(\tilde{Y}_i)$ is the
    ...
    [heteroscedastic]{.orange} data or when the above
...
-   [All]{.orange} the [linear smoothers]{.orange} presented in this
    unit (Nadaraya-Watson, local linear regression, regression and
...
-   The [computations]{.orange} and the [theory]{.blue} are not as
    straightforward and transparent as in the regression case, but they do
...
-   Manual placement of the knots is out of the question because it is an
...
-   The Green and Silverman theorem is remarkably [elegant]{.orange} and
    [powerful]{.blue}. A proof is offered [here](../extra/Proof_Optimal_Splines.pdf).
