...
- Another instance are the [thin-plate splines]{.blue}, in which the 2-$d$ [roughness]{.orange} penalty becomes
$$
...
- Simple and efficient algorithms for computing 1-d smoothing splines exists, such as `smooth.spline` available in **R**. 
:::
