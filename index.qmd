...
The primary source of this website's content are the textbooks [Azzalini and Scarpa (2011)]{.blue} and [Hastie, Tibshirani, and Friedman, J. (2009)]{.orange}. There a few pictures taken from these textbooks; in these occasions the original source is cited. 

I have made use of several other books, scientific articles, and datasets to complement the main textbooks. They are all cited at the end of each unit. Students are encouraged to consult the source material: these slides are just a concise summary. 

I am also grateful to Aldo Solari, whose material of the courses [Data Mining](https://aldosolari.github.io/DM/) and [Statistical Learning](https://aldosolari.github.io/SL/) have been used to lay the basis of this course.
